...
# Usage:
#   docker build --build-arg SGL_BRANCH=main --build-arg GPU_ARCH=gfx942-rocm720 -t sglang:rocm720-mi30x -f rocm720.Dockerfile .
#   docker build --build-arg SGL_BRANCH=main --build-arg GPU_ARCH=gfx950-rocm720 -t sglang:rocm720-mi35x -f rocm720.Dockerfile .
